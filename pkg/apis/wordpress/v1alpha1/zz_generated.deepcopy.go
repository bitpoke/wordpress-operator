...
func (in *WordpressSpec) DeepCopyInto(out *WordpressSpec) {
	*out = *in
	...
	if in.ReadOnlyContents != nil {
		in, out := &in.ReadOnlyContents, &out.ReadOnlyContents
		if *in == nil {
			*out = nil
		} else {
			*out = new(bool)
	...
	if in.KeepUploadsLocal != nil {
		in, out := &in.KeepUploadsLocal, &out.KeepUploadsLocal
		if *in == nil {
			*out = nil
		} else {
			*out = new(bool)
	...
	if in.PersistentVolumeTemplate != nil {
		in, out := &in.PersistentVolumeTemplate, &out.PersistentVolumeTemplate
		if *in == nil {
			*out = nil
		} else {
