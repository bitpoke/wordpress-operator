...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.Wordpress":     schema_pkg_apis_wordpress_v1alpha1_Wordpress(ref),
		"github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.WordpressList": schema_pkg_apis_wordpress_v1alpha1_WordpressList(ref),
		"github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.WordpressSpec": schema_pkg_apis_wordpress_v1alpha1_WordpressSpec(ref),
...
func schema_pkg_apis_wordpress_v1alpha1_Wordpress(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.WordpressSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.WordpressSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_wordpress_v1alpha1_WordpressList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.Wordpress"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1.Wordpress", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_wordpress_v1alpha1_WordpressSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"tlsSecretRef": {
						SchemaProps: spec.SchemaProps{
							Description: "TLSSecretRef a secret containing the TLS certificates for this site.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"readOnlyContents": {
						SchemaProps: spec.SchemaProps{
							Description: "ReadOnlyContents mounts the /wp-content/{themes,plugins,mu-plugins,languages} from persistentVolumeTemplate as RW. This is a pointer to distinguish between explicit false and not specified. Defaults to true.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"keepUploadsLocal": {
						SchemaProps: spec.SchemaProps{
							Description: "KeepUploadsLocal mounts from the volume specified in persistentVolumeTemplate the folder /wp-content/uploads as RW. This is a pointer to distinguish between explicit false and not specified. Defaults to false.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"ingressAnnotations": {
						SchemaProps: spec.SchemaProps{
							Description: "If specified apply these annotations to the Ingress resource created for this Wordpress Site.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"persistentVolumeTemplate": {
						SchemaProps: spec.SchemaProps{
							Description: "PersistentVolumeTemplate is the PVC used for cloning the site repository If not defined, the cloning takes place into an emptyDir volume, not shared by the pods in deployment.",
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.Affinity", "k8s.io/api/core/v1.EnvVar", "k8s.io/api/core/v1.PersistentVolumeClaim", "k8s.io/api/core/v1.ResourceRequirements", "k8s.io/api/core/v1.ServiceSpec", "k8s.io/api/core/v1.Toleration"},
	}
}
