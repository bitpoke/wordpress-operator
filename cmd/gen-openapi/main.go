...
import (
	...
	"github.com/presslabs/wordpress-operator/pkg/apis/wordpress"
	wpapi "github.com/presslabs/wordpress-operator/pkg/apis/wordpress/v1alpha1"
	wpversion "github.com/presslabs/wordpress-operator/pkg/version"
)

var (
	group       = wordpress.GroupName
	version     = wpapi.SchemeGroupVersion.Version
	resourceCRD = ""
)
...
func main() {
	...
	cmd := &cobra.Command{
		Use:   "wordpress-gen-crd",
		Short: fmt.Sprintf("Generate Wordpress Operator CRDs (%s)", wpversion.Get()),
		Run: func(cmd *cobra.Command, args []string) {
			if CRDcfg, exists := wpapi.CRDs[resourceCRD]; !exists {
